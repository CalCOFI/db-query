...
// public CalCOFI release Parquet (cached after first call); tables resolve
// through the release catalog (lib/release.js), never a hand-built URL.
//
...
import { readParquetFor } from "./release.js";
